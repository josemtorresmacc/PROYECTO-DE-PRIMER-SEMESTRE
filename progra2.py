...
def pltantmon():
    ...
    if plt.left <= 0:
        marcadorj1 += 1
        text_surface = font.render(u'PUNTO PARA JUGADOR 1', True, ligth_grey)
        screen.blit(text_surface,(screen_width/2 - 215,screen_height/2 - 40))
        pygame.display.flip()
        time.sleep(2)
        plt_restart()
    if plt.right >= screen_width:
        marcadorj2ia += 1
        text_surface = font.render(u'PUNTO PARA JUGADOR 2', True, ligth_grey)
        screen.blit(text_surface,(screen_width/2 - 215,screen_height/2 + 40))
        pygame.display.flip()
        time.sleep(2)
        plt_restart()
...
while True:
    ...
    pygame.draw.polygon(screen,(COLOR,COLOOR,COLOOOR),[(40,325),(650,0),(1260,325),(650,650)],10)
